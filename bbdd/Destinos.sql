...
-- Tiempo de generación: 03-08-2020 a las 12:35:24
...
(2, 'Ruta rio Ñora', 'Se trata de un paseo agradable por la ribera del Arroyo de la Ñora, con espesa vegetación y de fácil realización. Es ideal para hacerla con niños, incluso de corta edad.', 'Baja', 1, 'bar'),
(3, 'Camino Encantado', 'Recorrido muy cómodo y tranquilo para ir disfrutando con niños mientras buscan las Xanas y los Trasgos\r\nEl camino es sencillo, tan sólo un tramo que se va por la carretera  , pero se disfrutara', 'Baja', 1, 'Si, bar');
